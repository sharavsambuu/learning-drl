#
# PPO-style GRPO (Critic-less) + Outcome-Based Group Advantage + Reference-KL + Entropy Bonus
#
...
#    - Cold-start reference fix:                     periodically update reference to current policy
    ...
    for episode in range(num_episodes):
        ...
        if debug and (episode % 10 == 0):
            print(f"Ep {episode:6d} | Steps {global_step:9d} | "
                  f"GroupMeanR {group_mean_reward:9.3f} | Std {group_std_reward:7.3f} | "
